 ...
 * a 64-bit value do something like "*pc + (((u64)*pb)<<32)".
 */
void hashlittle2( 
...
{
	i32 nIndex = 0;
	u32 dwHashA = 0xFFEEDDCC;
	u32 dwHashB = 0xBBAA0099;
	...
	hashword2((u32*)s_szBuffer, nIndex/4, &dwHashA, &dwHashB);
